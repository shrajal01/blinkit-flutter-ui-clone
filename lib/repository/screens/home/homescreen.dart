...
class HomeScreen extends StatelessWidget {
  ...
  var data = [
    {"img": "LDC.png", "text": "Lights, Diyas \n & Candles"},
    {"img": "DandG.png", "text": "Diwali \n Gifts"},
    {"img": "AandG.png", "text": "Appliances  \n & Gadgets"},
    {"img": "HandL.png", "text": "Home \n & Living"}
  ];
  var categroy = [
    {"img": "GGWL.png", "text": "Golden Glass\n Wooden Lid Candle (Oudh)"},
    {"img": "mithai.png", "text": "Royal Gulab Jamun\n By Bikano"},
    {"img": "bhujia.png", "text": "Bikaji \n Bhujia"},
  ];
  var grocerykitchen = [
